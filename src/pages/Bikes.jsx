          ...
          <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
            ...
            {currentStep === 1 && (
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-400 pt-2 text-center">Rental Duration: <span className="font-bold text-gray-700">{totalDays} days</span></p>
              </div>
            )}
            ...
            {currentStep === 2 && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-500 mb-1">Additional Notes (Optional)</label>
                  <textarea 
                    value={riderNotes} 
            ...
            {currentStep === 4 && (
              <div className="space-y-5">
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-gray-200 text-xs space-y-2">
                  ...
                  <div className="border-t-2 border-gray-200 pt-2 flex justify-between font-black text-sm text-orange-650">
          ...
          <div className="bg-slate-50 border-t border-gray-150 p-4 flex justify-between items-center">
            {currentStep > 1 ? (
              <button 
                ...
                className="px-4 py-2 bg-white border border-gray-200 text-gray-600 text-xs font-semibold rounded-lg transition-all"
              >
                Back
              </button>
            ) : (
            ...
            {currentStep < 4 ? (
              <button 
                ...
                className="px-5 py-2.5 bg-orange-600 hover:bg-orange-700 text-white font-semibold text-xs rounded-lg transition-all shadow-sm flex items-center gap-1.5"
              >
              ...
              <button 
                ...
                className="px-6 py-2.5 bg-orange-600 hover:bg-orange-700 text-white font-bold text-xs rounded-lg transition-all shadow-sm disabled:opacity-70"
              >
...
export default function Bikes() {
  ...
  // Poll for saved wishlist updates
  useEffect(() => {
    const handleStorageChange = () => {
      setWishlistVersion((v) => v + 1);
    };
    window.addEventListener("storage", handleStorageChange);
    // Custom trigger hook for local edits inside the same window
