    ...
    <div className="bg-slate-50 min-h-screen font-sans overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto text-white">
          ...
          >
            Premium bikes • Full insurance • 24/7 support • Delivered to your
            hotel in Biratnagar and Belbari
          </motion.p>
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/bikes"
                className="px-10 py-5 bg-cyan-500 text-black font-bold text-xl rounded-full shadow-2xl hover:shadow-cyan-500/50 hover:bg-cyan-400 transition-all hover:-translate-y-1 block"
              >
                Find Your Bike
              </Link>
            </motion.div>
      ...
      >
        <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl p-10 md:p-16 overflow-hidden">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 text-center">
            {STATS.map((stat, i) => (
              ...
              >
                ...
                <p className="mt-3 text-sm md:text-base font-bold text-gray-500 uppercase tracking-wider">
                  {stat.label}
                </p>
              </motion.div>
            ))}
          ...
          >
            {FEATURES.map((f, i) => (
              <motion.div
                ...
                className="group bg-white p-10 rounded-3xl border border-gray-100 hover:border-cyan-500/50 shadow-xl transition-all duration-300"
              >
                <motion.div
                  className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-cyan-50 text-cyan-600 flex items-center justify-center transition-transform"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {featuredBikes.map((bike, index) => (
              <motion.div
                ...
                whileHover={{
                  y: -15,
                  boxShadow: "0 30px 60px -15px rgba(6, 182, 212, 0.4)",
                ...
                >
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    >
                      <Link
                        to="/bikes"
                        className="bg-cyan-500 text-black px-6 py-3 rounded-full font-bold transition-all duration-300 flex items-center gap-2"
                      >
                        Book <IconArrowRight />
                      </Link>
                    </motion.div>
          ...
          <motion.div variants={fadeInUp} className="text-center mt-16">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/bikes"
                className="inline-block px-12 py-5 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-xl rounded-full shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300"
              >
                View All Bikes
              </Link>
            </motion.div>
        ...
        <div className="relative z-10">
          ...
          <motion.div variants={fadeInUp} className="mt-12">
            ...
            >
              <Link
                to="/bikes"
                className="inline-block px-14 py-6 bg-white text-blue-900 font-bold text-xl md:text-2xl rounded-full shadow-2xl hover:shadow-cyan-300/50 transition-all duration-300"
              >
                Book Your Bike Now
              </Link>
            </motion.div>
