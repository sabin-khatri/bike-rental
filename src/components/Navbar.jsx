          ...
          >
            <div className="flex items-center justify-between p-5 border-b border-gray-100">
              <div className="flex items-center gap-2">
                <span className="text-lg font-bold tracking-tight text-gray-950">Bike<span className="text-orange-600">Rental</span></span>
              </div>
              <button
                className="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-50 text-gray-500 hover:bg-gray-150 transition-all font-semibold"
                onClick={onClose}
              >
                ✕
              </button>
            ...
            <div className="p-4 border-t border-gray-100">
              <Link to={dashboardPath} onClick={onClose} className="block">
                <button
                  className="w-full py-3 bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-xl text-sm transition-all shadow-sm shadow-orange-500/10"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
              ...
              return (
                <Link
                  ...
                  className={`relative px-4 py-2 text-sm font-semibold rounded-lg transition-all ${
                    isActive 
                      ? "text-orange-605 bg-orange-50/50" 
                      : "text-gray-600 hover:text-orange-600 hover:bg-slate-50"
                  }`}
                >
                  {item.name}
                  {isActive && (
          ...
          <div className="hidden md:block">
            <Link to={dashboardPath}>
              <button className="px-4.5 py-2 bg-orange-600 hover:bg-orange-700 text-white font-semibold text-xs rounded-lg shadow-sm shadow-orange-500/10 hover:shadow-orange-500/20 active:scale-98 transition-all">
          ...
          {/* Mobile menu trigger */}
          <button
            className="md:hidden w-9 h-9 flex flex-col items-center justify-center gap-1.5 bg-slate-50 hover:bg-slate-100 rounded-xl transition-all border border-gray-150"
